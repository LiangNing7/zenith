...
--
-- Host: 10.37.91.93    Database: zenith
-- ------------------------------------------------------
...
--
-- Current Database: `zenith`
--

/*!40000 DROP DATABASE IF EXISTS `zenith`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `zenith` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
...
(7,'p','role::user','/v1.Zenith/DeleteUser','CALL','deny','',''),
(8,'p','role::user','/v1.Zenith/ListUser','CALL','deny','',''),
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='博文表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
