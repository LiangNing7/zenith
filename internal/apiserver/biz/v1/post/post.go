...
//go:generate mockgen -destination mock_post.go -package post github.com/LiangNing7/zenith/internal/apiserver/biz/v1/post PostBiz
...
import (
	...
	"github.com/LiangNing7/zenith/internal/apiserver/pkg/conversion"
