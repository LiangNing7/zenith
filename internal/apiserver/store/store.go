...
//go:generate mockgen -destination mock_store.go -package store github.com/LiangNing7/zenith/internal/apiserver/store IStore,UserStore,PostStore,ConcretePostStore
