...
const (
	// defaultHomeDir 定义放置 zenith 服务配置的默认目录.
	defaultHomeDir = ".zenith"

	// defaultConfigName 指定 zenith 服务的默认配置文件名.
	defaultConfigName = "zn-apiserver.yaml"
)
